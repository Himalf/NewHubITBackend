...
module.exports.PostInstructor = async (req, res, upload) => {
    ...
    try {
        ...
        const newInstructor = new InstructorModal({
            courseID, image: req?.file?.path,
            courseID, name: req.body.name,
            courseID, post: req.body.post,
            courseID, email: req.body.email,
            courseID, aboutMe: req.body.aboutMe,
            courseID, skill: req.body.skill,
            courseID, experience: req.body.experience,
        });
